...
const resources = [
    ...
    { title: "Local Food Hubs & USDA Directory", styles: ["Stabilizer", "Keeper"], type: "Agriculture", desc: "Practical local agriculture networks for building ongoing neighborhood food resilience.", url: "https://www.usda.gov/local-food-directories" },
    ...
    { title: "Compost Coalition", styles: ["Stabilizer"], type: "Soil Health", desc: "Decentralized community composting networks converting urban waste to living soil.", url: "https://www.compostfoundation.org" },

    { title: "Sierra Club Volunteer Portal", styles: ["Architect", "Stabilizer", "Guardian"], type: "Volunteer Operations", desc: "Database for finding localized outdoor stewardship, cleanups, and watchdogs.", url: "https://www.sierraclub.org/get-involved" },
    ...
    { title: "Old Growth Forest Network", styles: ["Keeper"], type: "Forest Protection", desc: "Identifying and preserving protected ancient forests across national county networks.", url: "https://www.oldgrowthforest.network" },
    ...
    { title: "Climate Emergency Fund", styles: ["Driver", "Guardian"], type: "Rapid Funding", desc: "Providing rapid grant funding to disruptive grassroots legal action networks.", url: "https://www.climateemergencyfund.org" },

    { title: "EPA Local Climate Program (Archive)", styles: ["Architect", "Guardian"], type: "Gov Archive", desc: "Mirrored frameworks for local government climate action, energy efficiency, and municipal planning.", url: "https://web.archive.org/web/20230601000000/https://www.epa.gov/statelocalclimate" },
    { title: "USDA Conservation Program (Mirror)", styles: ["Stabilizer", "Keeper"], type: "Gov Archive", desc: "Archived practices and guidelines for land management, soil health, and agricultural stewardship.", url: "https://web.archive.org/web/usda-csp" },
    { title: "NOAA Climate Resilience Toolkit", styles: ["Architect", "Visionary"], type: "Gov Portal", desc: "Federal framework and case studies helping communities navigate climate hazards and adaptation.", url: "https://toolkit.climate.gov" },
    { title: "Climate Data Initiative Archive", styles: ["Architect", "Guardian"], type: "Data Archive", desc: "Archived open-data repositories mapping coastal flooding, ecosystem vulnerability, and urban heat.", url: "https://web.archive.org/web/climate-data" },

    // --- Source 12 Additions ---
    { title: "Drawdown Solutions Library", styles: ["Driver"], type: "General Field", desc: "Comprehensive catalog detailing evidence-based climate solutions spanning energy, land use, and community action.", url: "https://drawdown.org/solutions" },
    ...
    { title: "ACE Youth Action Network", styles: ["Advocate"], type: "Youth & Student", desc: "Civic leadership fellowships and digital toolkits designed to support high school and college students in local organizing.", url: "https://allianceforyouthaction.org/our-network/" },
    ...
    { title: "Sunrise Movement Organizing Resources", styles: ["Advocate"], type: "Youth & Student", desc: "Youth-led campaign guides, civics playbooks, and local hub toolkits focused on climate policy and public organizing.", url: "https://www.sunrisemovement.org/resources/" },
    ...
    { title: "NOAA Teaching Climate", styles: ["Advocate"], type: "General Field", desc: "Professional development opportunities, climate data visualizers, and interactive tools for educators.", url: "https://www.climate.gov/teaching" },
    { title: "Citizens' Climate Education Youth", styles: ["Advocate"], type: "Youth & Student", desc: "Youth-focused education modules, advocacy curricula, campus organizing kits, and leadership training.", url: "https://citizensclimateeducation.org/programs-and-tools/youth/" },
    { title: "Climate Color Community", styles: ["Visionary"], type: "General Field", desc: "An ecosystem of peers and projects that make climate action feel clear, grounded, and aligned with your strengths.", url: "https://climatecolor.com/community" },
    ...
    { title: "Young Voices for the Planet (CELF)", styles: ["Visionary"], type: "Youth & Student", desc: "Short films and lesson plans showcasing student-led environmental projects to reframe youth agency.", url: "https://celfeducation.org/yvfp/" },
    ...
    { title: "AAM Facilities & Risk Management", styles: ["Stabilizer"], type: "Facilities", desc: "Operational guides covering energy efficiency, historic building retrofits, and disaster preparedness.", url: "https://www.aam-us.org/programs/resource-library/facilities-and-risk-management-resources/" },
    { title: "U.S. Climate Resilience Toolkit", styles: ["Stabilizer"], type: "Resilience", desc: "Interagency federal framework offering case studies and decision-support tools to build adaptation into master planning.", url: "https://toolkit.climate.gov/" },
    { title: "AAM Environment & Climate Network", styles: ["Stabilizer"], type: "Key Org", desc: "Operational frameworks and toolkits from AAM to help cultural sites integrate sustainability into operations.", url: "https://www.aam-us.org/programs/advocacy/issue-environmental-sustainability-and-museums/" },
    ...
    { title: "FEMA Community Resilience (Smithsonian)", styles: ["Stabilizer"], type: "Resilience", desc: "Smithsonian-hosted community resilience frameworks and risk management resources adapted from federal models.", url: "https://ssec.si.edu/climate-resilience" },
    ...
    { title: "State Climate Policy Dashboard (C2ES)", styles: ["Architect"], type: "Legal & Policy", desc: "State-by-state policy maps and tracking tools for clean energy standards and climate action plans.", url: "https://www.c2es.org/content/state-climate-policy/" },
    { title: "USGBC LEED for Existing Buildings", styles: ["Architect"], type: "Facilities", desc: "Standards and verification toolkits for green building maintenance, water conservation, and sustainable purchasing.", url: "https://www.usgbc.org/leed" },
    ...
    { title: "ENERGY STAR Non-Profit Workbook (RMI)", styles: ["Architect"], type: "Facilities", desc: "Independent building efficiency guides, benchmarking tools, and energy-saving checklists for non-profit facilities.", url: "https://rmi.org/our-work/buildings/" },
    ...
    { title: "Resilience Hubs Toolkit (USDN)", styles: ["Connector"], type: "Resilience", desc: "Urban Sustainability Directors Network guide for developing community facilities that support residents during climate disruptions.", url: "https://www.usdn.org/resilience-hubs.html" },
    { title: "Climate Toolkit Youth Network", styles: ["Connector"], type: "Youth & Student", desc: "Youth Climate Summit toolkits and frameworks for engaging young people in institutional decision-making.", url: "https://climatetoolkit.org/youth/resource-library/" },
