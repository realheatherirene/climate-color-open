...
const resources = [
    ...
    { title: "Drawdown Solutions Library", styles: ["Driver"], type: "General Field", desc: "Comprehensive catalog detailing evidence-based climate solutions spanning energy, land use, and community action.", url: "https://drawdown.org" },
    ...
    { title: "ACE Youth Action Network", styles: ["Advocate"], type: "Youth & Student", desc: "Civic leadership fellowships and digital toolkits designed to support high school and college students in local organizing.", url: "https://allianceforyouthaction.org" },
    ...
    { title: "Sunrise Movement Organizing Resources", styles: ["Advocate"], type: "Youth & Student", desc: "Youth-led campaign guides, civics playbooks, and local hub toolkits focused on climate policy and public organizing.", url: "https://www.sunrisemovement.org" },
